...
function populateLastNameDropdown() {
...
function filterByLastName() {
        const selectedLastName = document.getElementById("lastNameDropdown").value;
        alert("You selected last name: " + selectedLastName);
       
    }
    
    document.addEventListener("DOMContentLoaded", function() {
        populateLastNameDropdown();});
function filterByLetter() {
    const selectedLetter = document.getElementById("letterDropdown").value;
}
function saveToLocal() {
    localStorage.setItem('tblInput', JSON.stringify(tblInput));
